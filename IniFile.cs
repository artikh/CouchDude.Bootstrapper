...
namespace CouchDude.Bootstrapper
{
	...
	{
		/// <summary>The maximum size of a section in an ini file.</summary>
		/// <remarks>
		...
		/// </summary>
		/// <remarks>
		/// In each of the declarations below, we explicitly set CharSet to 
		...
		private static class NativeMethods
		{
			...
			[DllImport("kernel32.dll", CharSet = CharSet.Auto)]
			public static extern uint GetPrivateProfileString(
				string lpAppName, string lpKeyName, string lpDefault, [In, Out] char[] lpReturnedString, int nSize, string lpFileName);

			[DllImport("kernel32.dll", CharSet = CharSet.Auto)]
			public static extern int GetPrivateProfileString(
				string lpAppName, string lpKeyName, string lpDefault, IntPtr lpReturnedString, uint nSize, string lpFileName);
		...
		public string GetString(
			string sectionName, string keyName, string defaultValue)
		{
			if (sectionName == null)
			...
			NativeMethods.GetPrivateProfileString(sectionName, keyName, defaultValue, retval, MaxSectionSize, Path);
		...
		/// </exception>
		public int GetInt16(
			string sectionName, string keyName, short defaultValue)
		{
		...
		/// </exception>
		public int GetInt32(
			string sectionName, string keyName, int defaultValue)
		{
			if (sectionName == null)
				throw new ArgumentNullException("sectionName");
		...
		public double GetDouble(
			string sectionName, string keyName, double defaultValue)
		{
